        ...
        return (
             <div className="flex h-[calc(100vh-10rem)] w-full items-center justify-center p-6 text-center">
                <Card className="max-w-md glass-panel border-none premium-shadow p-12 rounded-[2.5rem]">
                    ...
                    <p className="text-muted-foreground mb-8 text-lg font-medium">L'accès direct au pilotage client est restreint pour le Super Admin. Veuillez impersonner un cabinet pour gérer ses clients.</p>
