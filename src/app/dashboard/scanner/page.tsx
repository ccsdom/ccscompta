  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] p-4 max-w-md mx-auto animate-in slide-in-from-bottom-4 fade-in duration-500">
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground mt-2">Prenez vos reçus et factures en photo directement depuis votre téléphone.</p>
      </div>

      <Card className="w-full glass-panel border-white/10 premium-shadow overflow-hidden">
        <CardContent className="p-6">
          {!selectedFile ? (
            <div 
              className="border-2 border-dashed border-white/20 rounded-2xl p-8 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-white/5 transition-colors group h-64"
            ...
            >
              ...
              <p className="text-xs text-muted-foreground">Appuyez pour ouvrir l'appareil photo</p>
            </div>
          ) : (
